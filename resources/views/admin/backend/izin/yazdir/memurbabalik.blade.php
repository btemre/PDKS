    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
        <tr>
            <td width="1060" height="43">
                <p align="center"><b>
                        <font face="Times New Roman"><span style="font-size:16pt;">MEMUR MAZERET İZİN FORMU</span></font>
                    </b>
                    <font size="4"></font>
                </p>
            </td>
                        ...
                        <td width="1062" height="67" colspan="3">
                            <p align="left">
                                <font face="Times New Roman"><span style="font-size:14pt;"><br>
                                        &emsp;&emsp;&emsp;657 sayılı Devlet Memurları Kanununun 104. Maddesine göre
                                        {{ \Carbon\Carbon::parse($izin->izin_baslayis)->format('d/m/Y') }} tarihinden
                                        geçerli olmak üzere<br>&emsp;&emsp;  eşimin doğum yapması nedeniyle 
                                        {{ $izin->izin_suresi }} ({{ yaziylasayi($izin->izin_suresi) }}) gün süre ile
                                        mazeret izni verilmesini arz ederim.</span>
                        ...
                        <td width="1060" height="61" colspan="3">
                            <p align="left">
                                <font style="font-size:14pt;" face="Times New Roman">
                                    ...
                                    mazeret izni kullanmasında sakınca olmadığını arz ederim.
                                </font>
                            </p>
                        </td>
                    </tr>
                    ...
                    <td width="1061" height="29" colspan="5">
                        <p align="left">
                            <font style="font-size:14pt;" face="Times New Roman">&emsp;&emsp;&emsp;Adı geçen personel
                                yukarıda belirtilen mazeret iznini ...../...../<?= date('Y') ?> -
