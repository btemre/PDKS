...
<table border="2" width="904" height="1310" bordercolor="black" cellspacing="0" cellpadding="0">
        ...
        <td width="895" height="528" colspan="3">
            <table border="0" cellpadding="0" cellspacing="0" width="1061" height="423">
                    ...
                    <td width="1062" height="67" colspan="5">
                        <p align="left">
                            <font face="Times New Roman" style="font-size:14pt;"><span>
                                        ...
                                        &emsp;&emsp;&emsp;&emsp;&emsp;657 Sayılı Devlet Memurları Kanununun 105 ve 107.
                                        Maddeleri uyarınca {{ tarih($izin->izin_baslayis) }} tarihinden <br><br>&emsp;
                                        &emsp;
                                        itibaren {{ $izin->izin_suresi }} ({{ yaziylasayi($izin->izin_suresi) }}) gün süre
                ...
                <tr>
                    ...
                    <td width="282" height="6" colspan="2">&nbsp;</td>
                    <td width="282" height="6" colspan="2">
                        <p align="center"><b>
                                <font face="Times New Roman"><span
                                            style="font-size:14pt;">{{ $ayar->ayar_basmuhendis }}</span></font>
                            </b></p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="282" height="11" colspan="2">&nbsp;</td>
                    <td width="282" height="11" colspan="2">
                        <p align="center"><b>
                                <font face="Times New Roman"><span
                                            style="font-size:14pt;">{{ $ayar->ayar_basmuhendisunvan }}</span></font>
                            </b></p>
                    </td>
                </tr>
                <tr>
    ...
    <tr>
        <td width="1061" height="29" colspan="5">
            <p align="left">
                <font style="font-size:14pt;" face="Times New Roman">&emsp;&emsp;&emsp;Adı geçen, hastalık iznini
                    ...../...../<?= date('Y') ?> ile ....../....../<?= date('Y') ?> tarihleri arasında (......) gün
                     kullanarak görevine başlamıştır.</font>
            </p> <br>
        </td>
    </tr>
    <tr>
