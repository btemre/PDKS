...
<body bgcolor="white" text="black" link="blue" vlink="purple" alink="red">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="1062" height="412">
                        ...
                        <td width="1062" height="67" colspan="3">
                            <p align="left">
                                <font face="Times New Roman"><span style="font-size:14pt;"><br>
                                        &emsp;&emsp;&emsp;Toplu İş Sözleşmesinin 60. Maddesine göre
                                        {{ tarih($izin->izin_baslayis) }} tarihinden geçerli olmak üzere
                                        {{ $izin->izin_yil }} yılı iznimden <br>&emsp;&emsp; {{ $izin->izin_suresi }}
                                        ({{ yaziylasayi($izin->izin_suresi) }}) gün süre ile yıllık izin verilmesini
                                        müsaadelerinize arz ederim.</span>
                    ...
                    <tr>
                        <td width="137" height="17"><b>
                                <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;T.C. Kimlik No</span>
                                </font>
                            </b></td>
                        <td width="925" height="17" colspan="2"><b><span
                                    style="font-size:14pt;">:</span></b><span
                                style="font-size:14pt;">{{ $izin->personel_tc }}</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="925" height="12" colspan="2"><b><span
                                    style="font-size:14pt;">:</span></b><span
                                style="font-size:14pt;">{{ $izin->unvan_ad }}</span></td>
                    </tr>
                    <tr>
                        <td width="137" height="12"><b>
                                <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;İşe Giriş
                                        Tarihi</span></font>
                            </b></td>
                        <td width="925" height="12" colspan="2"><b><span
                                    style="font-size:14pt;">:</span></b><span
                                style="font-size:14pt;">{{ tarih($izin->personel_isegiristarih) }}</span></td>
                    </tr>
                    <tr>
                        ...
                        <td width="925" height="11" colspan="2"><b><span
                                    style="font-size:14pt;">:</span></b><span
                                style="font-size:14pt;">{{ $izin->izin_adresi ?: $izin->personel_adres }}
                            </span></td>
                    </tr>
                    <!-- <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="1060" height="417">
                        ...
                        <td width="1060" height="61" colspan="3">
                            <p align="left">
                                <font style="font-size:14pt;" face="Times New Roman">
                                    ...
                                    &emsp;&emsp;&emsp;İlgilinin belirtilen tarihler arasında {{ $izin->izin_suresi }}
                                    ({{ yaziylasayi($izin->izin_suresi) }}) gün {{ $izin->izin_yil }} yılı iznini
                                    kullanmasında sakınca olmadığını arz ederim.
                                </font>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="200" height="44">
                            <font face="Times New Roman" style="font-size:14pt;">......./......../<?= date('Y') ?>
                            </font>
                        </td>
                    </tr>
                    <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="1061" height="423">
                    ...
                    <tr>
                        ...
                        <td width="603" height="24">
                            <font face="Times New Roman"><span style="font-size:14pt;">(.....) Gün ....... İzni</span>
                            </font>
                        </td>
                        <td width="349" height="24" colspan="3">
                            <font face="Times New Roman"><span style="font-size:14pt;">(.....) Gün hafta tatili</span>
                            </font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="603" height="16">
                            <font face="Times New Roman"><span style="font-size:14pt;">(.....) Gün genel tatil</span>
                            </font>
                        </td>
                        <td width="349" height="16" colspan="3">
                            <font face="Times New Roman"><span style="font-size:14pt;">(.....) Gün ücretsiz yol
                                    izni</span></font>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="1061" height="10" colspan="5">
                            <font style="font-size:14pt;" face="Times New Roman">&emsp;&emsp;&emsp;Gereğini
                                bilgilerine arz ederim.</font>
                        </td>
                    </tr>
                    <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
        ...
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman"><b>2. </b>2. Nüsha Bütçe Kesin Hesap ve Raporlama
                    Şb.Md'ne gönderilir.</font>
            </td>
        </tr>
        <!-- <tr>
        ...
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman"><b>3. </b>3. Nüsha işçinin dosyasına konur.
                </font>
            </td>
        </tr>
    </table>
