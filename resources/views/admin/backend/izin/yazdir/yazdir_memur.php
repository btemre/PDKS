...
<table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
    <tr>
        <td width="1060" height="100">
            <p align="left"><b>
                    <font face="Times New Roman"><span style="font-size:16pt;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;T.C.<br>
                    ...
                    <td width="1062" height="67" colspan="3">
                        <p align="left">
                            <font face="Times New Roman"><span style="font-size:14pt;"><br>
                                        &emsp;&emsp;&emsp;657 sayılı Devlet Memurları Kanununun 102. Maddesine göre <?= date("d/m/Y", strtotime($query[0]['izin_baslayis'])) ?> tarihinden geçerli olmak üzere  <?= $query[0]['izin_yil'] ?> yılı iznime <br>&emsp;&emsp;  mahsuben <?= $query[0]['izin_suresi'] ?> (<?= yaziylasayi($query[0]['izin_suresi']) ?>) gün süre ile yıllık izin verilmesini arz ederim.</span>
                    ...
                    <td width="1060" height="61" colspan="3">
                        <p align="left">
                            <font style="font-size:14pt;" face="Times New Roman">
                                ...
                                &emsp;&emsp;&emsp;İlgilinin belirtilen tarihler arasında <?= $query[0]['izin_suresi'] ?> (<?= yaziylasayi($query[0]['izin_suresi']) ?>) gün <?= $query[0]['izin_yil'] ?> yılı iznini kullanmasında sakınca olmadığını arz ederim.
                            </font>
                        </p>
                    </td>
                </tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="1061" height="423">
                ...
                <tr>
                    <td width="1061" height="29" colspan="5">
                        <p align="left">
                            <font style="font-size:14pt;" face="Times New Roman">&emsp;&emsp;&emsp;Adı geçen personel yukarıda belirtilen yıllık iznini ...../...../<?= date("Y"); ?> - ....../....../<?= date("Y"); ?> tarihleri arasında (......) gün kullanmıştır</font>
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="603" height="1">
                        <font face="Times New Roman"><span style="font-size:14pt;">(.....) Günü yol iznidir</span></font>
                    </td>
...
<table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
    <tr>
        <td width="1060" height="10">
            <font style="font-size:10pt;" face="Times New Roman"><b>1-</b>Merkez Teşkilatında bir nüsha olarak düzenlenir. İzin bitiminde formun II.
    ...
    <tr>
        <td width="1060" height="10">
            <font style="font-size:10pt;" face="Times New Roman"><b>2-</b>Taşra Teşkilatında iki nüsha olarak düzenlenir . İkinci nüsha izne başlandığında,
                birinci nüsha ise izin bitiminde formun 2. bölümü doldurulup onaylandıktan sonra Personel Şube Müdürlüğüne gönderilir ve her iki
