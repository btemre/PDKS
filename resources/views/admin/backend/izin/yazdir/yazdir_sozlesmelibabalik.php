...
$id = $_GET['izin_id'];
$sql = "SELECT p.personel_adres,i.izin_vefat,d.durum_ad,u.unvan_ad,p.personel_adsoyad,p.personel_tc,p.personel_sicilno,it.izin_ad,i.izin_tarih,
...
<html>
<head>
    <title> Sözleşmeli Memur Babalık İzin Formu </title>
</head>
...
&emsp;&emsp;&emsp;657 Sayılı Devlet Memurları Kanununun 104. maddesine göre eşimin doğum yapması nedeniyle <?= date("d.m.Y",strtotime($query[0]['izin_baslayis'])) ?> tarihinden<br>&emsp; itibaren geçerli olmak üzere <?= $query[0]['izin_suresi'] ?> (<?= yaziylasayi($query[0]['izin_suresi']) ?>) günlük <?= $query[0]['izin_ad'] ?> verilmesini arz ederim.
<br>
&nbsp;</span></font></p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="925" height="17" colspan="3"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?= $query[0]['personel_tc']; ?></span></td>
                </tr>
                <tr>
                    <td width="137" height="18" colspan="2"><b><font face="Times New Roman"><span style="font-size:14pt;">&nbsp;Sicil No</span></font></b></td>
                    <td width="925" height="18" colspan="3"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?= $query[0]['personel_sicilno']; ?></span></td>
                </tr>
                <tr>
                    <td width="137" height="24" colspan="2"><b><font face="Times New Roman"><span style="font-size:14pt;">&nbsp;Adı, Soyadı</span></font></b></td>
                    <td width="925" height="24" colspan="3"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?= $query[0]['personel_adsoyad'] ?></span></td>
                </tr>
                <tr>
                    <td width="137" height="12" colspan="2"><b><font face="Times New Roman"><span style="font-size:14pt;">&nbsp;Görevi</span></font></b></td>
                    <td width="925" height="12" colspan="3"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?= $query[0]['unvan_ad']; ?></span></td>
                </tr>
                    <td width="137" height="12" colspan="2"><b><font face="Times New Roman"><span style="font-size:14pt;">&nbsp;Tel</span></font></b></td>
                    <td width="925" height="12" colspan="3"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> 0<?= $query[0]['personel_telefon']; ?></span></td>
                </tr>
                <tr>
                    <td width="137" height="11" colspan="2"><b><font face="Times New Roman"><span style="font-size:14pt;">&nbsp;İzin Adresi</span></font></b></td>
                    <td width="925" height="11" colspan="3"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?php if ($query[0]['izin_adresi'] == is_null(0)) echo $query[0]["personel_adres"]; else echo $query[0]['izin_adresi']; ?></span></td>
                </tr>
                <tr>
...
&nbsp;</td>
                ...
                <tr>
                    ...
                    <td width="200" height="22" colspan="2">
                        <p align="center"><b><span style="font-size:14pt;"><font face="Times New Roman"><?= $variable[0]['ayar_yonetici'] ?></font></span></b></p>
                    </td>
                </tr>
                <tr>
                    <td width="862" height="10" colspan="3">&nbsp;</td>
                    <td width="200" height="10" colspan="2">
                        <p align="center"><b><span style="font-size:14pt;"><font face="Times New Roman"><?= $variable[0]['ayar_yoneticiunvan'] ?></font></span></b></p>
                    </td>
                </tr>
                <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="1061" height="364">
                <tr>
                    ...
                    <td width="1061" height="77" colspan="2"> <br>
                        ...
                        <p>&nbsp;</p>
                        <p><font face="Times New Roman" style="font-size:14pt;">&emsp;&emsp;&emsp;Adı geçen personel yukarıda belirtilen iznini  ...../...../<?= date("Y"); ?>  -  ....../....../<?= date("Y"); ?> tarihleri arasında (......) gün kullanmıştır</font><br>
&nbsp;</p>
                    </td>
                </tr>
                <tr>
