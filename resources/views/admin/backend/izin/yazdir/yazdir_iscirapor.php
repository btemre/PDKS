...
<table border="2" width="904" height="1310" bordercolor="black" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td width="93" height="90" rowspan="3">
            <p align="center"><font style="writing-mode:rl-tb"><b>Hastalık<br>
            </b></font><b>İzni<br>
            Kullananın</b></p>
        </td>
                ...
                <tr>
                    <td width="1062" height="67" colspan="5">
                        <p align="left"><font face="Times New Roman" style="font-size:14pt;"><span> 
                            ...
                            &emsp;&emsp;&emsp;&emsp;&emsp;Toplu İş Sözleşmesinin 60. Maddesine göre <?= date("d.m.Y",strtotime($query[0]['izin_baslayis'])) ?> tarihinden <br><br>&emsp; &emsp; başlayarak <?= $query[0]['izin_suresi'] ?> (<?= yaziylasayi($query[0]['izin_suresi']) ?>) gün süre ile izinli sayılmasını arz ederim.
                            <br> <br>
                        &nbsp;</span></font></p>
                    </td>
                </tr>
