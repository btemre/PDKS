...
<html>
<head>
    <title> Sözleşmeli Memur Evlilik İzin Formu </title>
</head>
...
&emsp;&emsp;&emsp;657 Sayılı Devlet Memurları Kanununun 104. maddesine göre <?= date("d.m.Y",strtotime($query[0]['izin_baslayis'])) ?> tarihinden geçerli olmak üzere <br>&emsp;  <?= $query[0]['izin_suresi'] ?> (<?= yaziylasayi($query[0]['izin_suresi']) ?>) günlük <?= $query[0]['izin_ad'] ?> verilmesini arz ederim.
<br>
&nbsp;</span></font></p>
                    </td>
                </tr>
