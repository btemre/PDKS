                        ...
                        <td width="1062" height="67" colspan="3">
                            <p align="left">
                                <font face="Times New Roman"><span style="font-size:14pt;"><br>
                                        &emsp;&emsp;&emsp;657 sayılı Devlet Memurları Kanununun 102. Maddesine göre
                                        {{ \Carbon\Carbon::parse($izin->izin_baslayis)->format('d/m/Y') }} tarihinden
                                        geçerli olmak üzere {{ $izin->izin_yil }} yılı iznime <br>&emsp;&emsp; mahsuben
                                        {{ $izin->izin_suresi }} ({{ yaziylasayi($izin->izin_suresi) }}) gün süre ile
                                        yıllık izin verilmesini arz ederim.</span>
        ...
        <tr>
            <td width="1060" height="13">
                <table border="0" cellpadding="0" cellspacing="0" width="1060" height="400">
                        ...
                        <td width="1060" height="61" colspan="3">
                            <p align="left">
                                <font style="font-size:14pt;" face="Times New Roman">
                                    <br>
                                    &emsp;&emsp;&emsp;İlgilinin belirtilen tarihler arasında
                                    {{ $izin->izin_suresi }}({{ yaziylaSayi($izin->izin_suresi) }}) gün
                                    {{ $izin->izin_yil }} yılı iznini kullanmasında sakınca olmadığını arz ederim.
                                </font>
                            </p>
                        </td>
                    </tr>
                    ...
                    <!-- Boşluk -->
                    <tr>
                        <td width="353" height="49">&nbsp;</td>
                        <td width="354" height="49">&nbsp;</td>
                        <td width="353" height="49">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <!-- Sol: Başmühendis -->
                        <td width="353" height="44" align="center">
                            <font face="Times New Roman" style="font-size:14pt;">
                                <b>{{ $ayar->ayar_yonetici }}<br>{{ $ayar->ayar_yoneticiunvan }}</b>
                            </font>
                        </td>

                        <!-- Orta boşluk -->
                        <td width="354" height="44">&nbsp;</td>

                        <!-- Sağ: Yönetici -->
                        <td width="353" height="44" align="center">
                            <font face="Times New Roman" style="font-size:14pt;">
                                <b>{{ $ayar->ayar_basmuhendis }}<br>{{ $ayar->ayar_basmuhendisunvan }}</b>
                            </font>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="1060" height="100" colspan="3">
                            <p align="center">
                                <font face="Times New Roman" style="font-size:14pt;">
                                    <b>UYGUNDUR<br><br>...../...../<?= date('Y') ?><br><br>&nbsp;</b>
                                </font>
                            </p>
                        </td>
                    </tr>
