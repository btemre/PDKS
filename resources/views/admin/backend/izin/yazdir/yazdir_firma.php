    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
        <tr>
            <td width="1060" height="43">
                <p align="center"><b>
                        <font face="Times New Roman"><span style="font-size:16pt;">İŞÇİ İZİN FORMU</span></font>
                    </b>
                    <font size="4"></font>
                </p>
            </td>
        ...
        <tr>
            <td width="1060" height="469">
                <table border="0" cellpadding="0" cellspacing="0" width="1062" height="412">
                        ...
                        <td width="1062" height="67" colspan="3">
                            <p align="left">
                                <font face="Times New Roman"><span style="font-size:14pt;"><br>
                                        &emsp;&emsp;&emsp;4857 sayılı İş Kanunu'na göre <?= $query[0]['izin_suresi'] ?> (<?= yaziylasayi($query[0]['izin_suresi']) ?>) gün <?= $query[0]['izin_yil'] ?> yılı iznimin <?= date("d.m.Y", strtotime($query[0]['izin_baslayis'])) ?> tarihinden geçerli olmak üzere <br>&emsp;&emsp;verilmesini müsadelerinize arz ederim.</span>
                    ...
                    <tr>
                        <td width="137" height="17"><b>
                                <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;T.C. Kimlik No</span></font>
                            </b></td>
                    ...
                    <tr>
                        <td width="137" height="24"><b>
                                <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;Adı Soyadı</span></font>
                            </b></td>
                    ...
                    <tr>
                        <td width="137" height="12"><b>
                                <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;Pozisyonu</span></font>
                            </b></td>
                        <td width="925" height="12" colspan="2"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?= $query[0]['unvan_ad']; ?></span></td>
                    </tr>
                    <tr>
                        <td width="137" height="12"><b>
                                <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;İşe Giriş Tarihi</span></font>
                            </b></td>
                    ...
                    <tr>
                        <td width="137" height="11"><b>
                                <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;İzin Adresi</span></font>
                            </b></td>
                        <td width="925" height="11" colspan="2"><b><span style="font-size:14pt;">:</span></b><span style="font-size:14pt;"> <?php if ($query[0]['izin_adresi'] == is_null(0)) echo $query[0]["personel_adres"];
                                                                                                                                            else echo $query[0]['izin_adresi']; ?></span></td>
                    </tr>
                    <!-- <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="1060" height="417">
                    <tr>
                        <td width="1060" height="43" colspan="3">
                            <p align="center">
                                <font face="Times New Roman"><span style="font-size:14pt;"><b><br>
                                            KARAYOLLARI 5. BÖLGE MÜDÜRLÜĞÜNE</b></span></font>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td width="1060" height="61" colspan="3">
                            <p align="left">
                                <font style="font-size:14pt;" face="Times New Roman">
                                    ...
                                    &emsp;&emsp;&emsp;İlgilinin belirtilen tarihler arasinda <?= $query[0]['izin_suresi'] ?> (<?= yaziylasayi($query[0]['izin_suresi']) ?>) gün <?= $query[0]['izin_yil'] ?> yılı iznini kullanmasında sakınca olmadığını arz ederim.
                                </font>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td width="779" height="44">
                            <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;</span></font>
                        </td>
                        <td width="141" height="44">&nbsp;</td>
                        <td width="200" height="44">
                            <font face="Times New Roman" style="font-size:14pt;">......./......../<?= date("Y"); ?></font>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="281" height="22" colspan="2">
                            <p align="center">
                                <font face="Times New Roman"><span style="font-size:14pt;"><b><?= $variable[0]['ayar_yonetici'] ?></b></span></font>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="281" height="10" colspan="2">
                            <p align="center">
                                <font face="Times New Roman"><span style="font-size:14pt;"><b><?= $variable[0]['ayar_yoneticiunvan'] ?></b></span></font>
                            </p>
                        </td>
                    </tr>
                    <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="1061" height="423">
                    ...
                    <tr>
                        ...
                        <td width="603" height="24">
                            <font face="Times New Roman"><span style="font-size:14pt;">(.....) Gün ....... İzni</span></font>
                        </td>
                        <td width="349" height="24" colspan="3">
                            <font face="Times New Roman"><span style="font-size:14pt;">(.....) Gün hafta tatili</span></font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="603" height="16">
                            <font face="Times New Roman"><span style="font-size:14pt;">(.....) Gün genel tatil</span></font>
                        </td>
                        <td width="349" height="16" colspan="3">
                            <font face="Times New Roman"><span style="font-size:14pt;">(.....) Gün ücretsiz yol izni</span></font>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="1061" height="29" colspan="5">
                            <p align="left">
                                <font style="font-size:14pt;" face="Times New Roman">&emsp;&emsp;&emsp;Adı geçen personel yukarıda belirtilen iznini ...../...../<?= date("Y"); ?> - ....../....../<?= date("Y"); ?> tarihleri arasında (......) gün kullanmıştır</font>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td width="1061" height="10" colspan="5">
                            <font style="font-size:14pt;" face="Times New Roman">&emsp;&emsp;&emsp;Gereğini bilgilerinize arz ederim.</font>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="282" height="6" colspan="2">
                            <p align="center"><b>
                                    <font face="Times New Roman"><span style="font-size:14pt;"><?= /*$variable[0]['ayar_mudur']*/ "" ?></span></font>
                                </b></p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="282" height="11" colspan="2">
                            <p align="center"><b>
                                    <font face="Times New Roman"><span style="font-size:14pt;"><?= /*$variable[0]['ayar_mudurunvan']*/ " " ?></span></font>
                                </b></p>
                        </td>
                    </tr>
                    <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman"><b>1. </b>3 Nüsha Düzenlenir.
        ...
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman"><b>2. </b>2. Nüsha Bütçe Kesin Hesap ve Raporlama Şb.Md'ne gönderilir.</font>
            </td>
        </tr>
        <!-- <tr>
        ...
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman"><b>3. </b>3. Nüsha işçinin dosyasına konur.</font>
            </td>
        </tr>
    </table>
</body>
