...
<head>
    <title>Memur Vefat İzin Formu</title>
</head>
...
<body bgcolor="white" text="black" link="blue" vlink="purple" alink="red">
    <table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
        <tr>
            <td width="1060" height="100">
                <p align="center"><b>
                        <font face="Times New Roman"><span style="font-size:16pt;">T.C.<br>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1060" height="43">
        <tr>
            <td width="1060" height="43">
                <p align="center"><b>
                        <font face="Times New Roman"><span style="font-size:16pt;">MEMUR İZİN FORMU</span></font>
                    </b>
                    <font size="4"></font>
                </p>
            </td>
    ...
    <table border="2" bordercolor="black" cellpadding="0" cellspacing="0" width="1066" height="972">
            ...
            <td width="1062" height="67" colspan="5">
                <p align="left">
                    <font face="Times New Roman" style="font-size:14pt;"><span>
                            <p align="center">
                                <font size="4"><b>KARAYOLLARI 5. BÖLGE MÜDÜRLÜĞÜNE</b></font>
                            </p> <br>
                            &emsp;&emsp;&emsp;657 Sayılı Devlet Memurları Kanununun 104. maddesine göre {{ tarih($izin->izin_baslayis) }} tarihinden geçerli olmak üzere <br>&emsp;{{ $izin->izin_vefat }} vefatından dolayı {{ $izin->izin_suresi }} ({{ yaziylaSayi($izin->izin_suresi) }}) günlük vefat izni verilmesini arz ederim.
                            <br>
                            &nbsp;
                        </span></font>
                </p>
        ...
        <tr>
            ...
            <td width="140" height="40">
                <font face="Times New Roman" style="font-size:14pt;">...../...../<?php echo date("Y"); ?></font>
            </td>
        </tr>

        <tr>
            <td width="137" height="17" colspan="2"><b>
        ...
        <tr>
            <td width="137" height="18" colspan="2"><b>
        ...
        <tr>
            <td width="137" height="24" colspan="2"><b>
        ...
        <tr>
            <td width="137" height="12" colspan="2"><b>
        ...
        <td width="137" height="12" colspan="2"><b>
                <font face="Times New Roman"><span style="font-size:14pt;">&nbsp;Tel</span></font>
            </b></td>
        ...
        <tr>
            <td width="137" height="11" colspan="2"><b>
        ...
        <tr>
            ...
            <td width="200" height="10" colspan="2">
                <p align="center"><b><span style="font-size:14pt;">
                            <font face="Times New Roman">{{ $ayar->ayar_yoneticiunvan }}</font>
                        </span></b></p>
            </td>
        </tr>
        <tr>
    ...
    <p align="center">
        <font style="font-size:14pt;"><b>...../...../<?php echo date("Y"); ?><br>
                <br>
                &nbsp;</b></font>
    </p>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="1061" height="364">
                <tr>
                    ...
                    <td width="1061" height="77" colspan="2"> <br>
                        <p align="center">
                            <font size="4"><b>PERSONEL ŞUBESİ MÜDÜRLÜĞÜNE</b></font>
                        </p>

                        <p>&nbsp;</p>
                        <p>
                            <font face="Times New Roman" style="font-size:14pt;">&emsp;&emsp;&emsp;Adı geçen personel yukarıda belirtilen iznini ...../...../<?php echo date("Y"); ?> - ....../....../<?php echo date("Y"); ?> tarihleri arasında (......) gün kullanmıştır</font><br>
                            &nbsp;
                        </p>
                    </td>
                </tr>
                <tr>
                    <td width="935" height="119">
                        <font face="Times New Roman" style="font-size:14pt;">&emsp;&emsp;&emsp;Bilgilerinize arz ederim.</font>
                    </td>
                </tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1060" height="auto">
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman"><b>1. </b>Merkez Teşkilatında bir nüsha olarak düzenlenir. İzin bitiminde formun 2. bölümü doldurulup onaylandıktan sonra, ilgilinin şahsi dosyasına konur.</font>
            </td>
        </tr>
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman"><b>2. </b>Taşra Teşkilatında iki nüshha olarak düzenlenir. ikinci nüsha izne başlanıldığında, birinci nüsha ise izin bitiminde formun 2. bölümü doldurulup</font>
            </td>
        </tr>
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman">&nbsp;&nbsp;&nbsp;onaylandıktan sonra, Personel Şube Müdürlüğüne gönderilir ve her iki nüsha birleştirilerek ilgilinin şahsi dosyasýna konur.</font>
            </td>
        </tr>
        <tr>
            <td width="1060" height="10">
                <font style="font-size:10pt;" face="Times New Roman"><b>3. </b>Form, izin başlangıcından önce kayda alınır.</font>
            </td>
        </tr>
    </table>
</body>
