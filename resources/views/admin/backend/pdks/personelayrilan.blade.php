                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{route(name: 'personel.listesi')}}">Personeller</a></li>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-3">
                                <div>
                                    ...
                                    <input type="number" id="personel_sicilno" class="form-control"
                                        placeholder="Aralara Çizgi Koymayın!" name="personel_sicilno" autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div>
                                    <label for="tel-field" class="form-label">Telefon</label>
                                    <input type="number" id="personel_telefon" class="form-control" name="personel_telefon"
                            ...
                            <div class="col-lg-1">
                                ...
                                <input type="number" id="personel_derece" class="form-control" name="personel_derece" />
                            </div>
                            <div class="col-lg-1">
                                <label for="companyname-field" class="form-label">Kademe</label>
                                <input type="number" id="personel_kademe" class="form-control" name="personel_kademe" />
                            </div>
                            <div class="col-lg-3">
                                <div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <textarea id="personel_aciklama" class="form-control" name="personel_aciklama"
                                    rows="2"></textarea>
                            </div>
                        </div>
                    </div>
        ...
        $(document).ready(function () {
            ...
            $('#ajax-crud-datatable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'birim_ad', name: 'birim.birim_ad' }, // Doğru isimlendirme
                    { data: 'ayrilis_tur', name: 'ayrilis.ayrilis_tur' }, // Doğru isimlendirme
                ...
                success: function (res) {
                    if (res.status === 'success') {
                        ...
                        if (res.data.personel_resim) {
                            $('#companylogo-img').attr('src', '/' + res.data.personel_resim + '?t=' + new Date().getTime());
                        } else {
