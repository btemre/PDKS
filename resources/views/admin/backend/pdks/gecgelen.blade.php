...
@section('admin')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="ajax-crud-pdksgecgelen"
    ...
    // DataTable Tanımlama
    let table = $('#ajax-crud-pdksgecgelen').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('pdks.gecgelen') }}",
            data: function(d) {
                d.date_range = dateRange; // Güncel tarih aralığını gönder
            }
        },
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    ...
                    if (girisData) {
                        ...
                        if (farkDakika < 3) return 'Çıkış Yapılmadı';
                    }
    ...
    // Tarih aralığı iptal edilirse filtreyi kaldır
        ...
        $('#PersonelForm').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#ajax-crud-pdksgecgelen').DataTable().ajax.reload(null, false);
