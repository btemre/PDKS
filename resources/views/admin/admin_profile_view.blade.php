                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="name" placeholder="Enter your firstname" name="name" value="{{ $profileData->name }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="lastnameInput" class="form-label"> Kullanıcı Adı</label>
                                                <input type="text" class="form-control"   id="username" placeholder="Enter your lastname" name="username" value="{{ $profileData->username }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="phonenumberInput" placeholder="Enter your phone number" name="phone" value="{{ $profileData->phone }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" id="emailInput" placeholder="Enter your email" name="email" value="{{ $profileData->email }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="address" placeholder="Enter your email" name="address" value="{{ $profileData->address }}">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-8">
                                            <div class="mb-3 pb-2">
                                                <label for="exampleFormControlTextarea" class="form-label">Açıklama</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea" placeholder="Enter your description" name="detay" rows="3">{{ $profileData->detay }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="mb-3"><label for="resim" class="form-label">Resim</label><div><input class="form-control form-control-lg" name="photo" id="image" type="file"></div>                                            
                                            </div>
                                        </div>
                                        <div class="col-lg-1">
                                            <div class="mb-3">
                                                <img id="ShowImage" src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/avatar.png') }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image  shadow" alt="user-profile-image">
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-lg-12">
